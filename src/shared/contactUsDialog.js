...
const ContactUsDialog = ({ isOpen, onClose }) => {
  const [selectedPhone, setSelectedPhone] = useState('0660521477'); // Default phone number

  if (!isOpen) return null;

  const handleWhatsAppClick = () => {
    const phoneNumber = selectedPhone === '0660521477' ? '+27660521477' : '+27691912963';
      ...
      <div style={modalContent}>
        ...
        <div style={contactInfo}>
          ...
          <div style={phoneSelectContainer}>
            <label style={contactLabel}>Select Phone Number:</label>
            <select
              value={selectedPhone}
              onChange={handlePhoneChange}
              style={phoneSelect}
            >
              <option value="0660521477">066 052 1477</option>
              <option value="0691912963">069 191 2963</option>
            </select>
          </div>
          ...
          <div style={contactItemContainer} onClick={handleCallClick}>
            ...
            <div style={contactText}>
              ...
              <div style={contactValue}>{selectedPhone === '0660521477' ? '066 052 1477' : '069 191 2963'}</div>
            </div>
          </div>
